...
class AuthUser(models.Model):
    ...
    def is_authenticated(self):
        """
                Всегда возвращает True. Спокоб узнать был ли пользователь авторизован
                """
        return True
...
class Follower(models.Model):
    ...
    subscribers = models.ForeignKey(AuthUser, on_delete=models.CASCADE, related_name='subscribers')

    def __str__(self):
        return f'{self.subscribers} подписан на {self.user}'
